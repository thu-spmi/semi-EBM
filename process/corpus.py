...
if wb.is_window():
    ...
    dataroot = 'data/raw/1-billion-word-language-modeling-benchmark-r13output/'
...
def extract_1billion_vocab():
    ...
    word_count = 'data/processed/google1B/vocab_count_all.txt'
    ...
    for cutoff in range(0, 21):
        ...
        file = 'data/processed/google1B/vocab_cutoff{}.txt'.format(cutoff)
    ...
    for size in [10000, 20000, 50000]:
        ...
        file = 'data/processed/google1B/vocab_{}K.txt'.format(size // 1000)
        write_vocab(file, v, is_sorted=True, write_info=('id', 'word', 'count'))
...
if __name__ == '__main__':
    ...
    wb.mkdir('data/processed/google1B')
    v = vocab.Vocab()
    for cutoff in [3, 5, 10]:
        ...
        v.write('data/processed/google1B/vocab_cutoff{}.txt'.format(cutoff))
        info['vocab_cut%d' % cutoff] = 'data/processed/google1B/vocab_cutoff{}.txt'.format(cutoff)

    with open('data/processed/google1B/data.info', 'wt') as f:
